    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">KAVYA</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">KAVYA's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Here is the small gift for you 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — BABYBOY 💖</h2>
          <p className="final-subtitle">I MISS YOU CUTUU🥹</p>
        </section>
      </div>
